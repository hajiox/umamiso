...
export default function UmamisoLP() {
  ...
  const faqs = [
    ...
    {
      question: "内容量や価格は？",
      answer: "内容量は120g × 2個セットで、価格は1,890円（税込）。馬肉、ごろごろ具材たっぷりで食べ応え抜群。",
    },
  ]
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-stone-50 rounded-2xl p-6 md:p-8">
              ...
              <p className="text-stone-700 mb-6 leading-relaxed">
                {`会津の馬刺しを支えるのが、会津畜産。全国（主に北海道）の生産者から素馬を仕入れ、自社の牧場で２ヶ月から３ヶ月かけて丁寧に肥育。独自の配合飼料（遊離アミノ酸含有量を増やし旨味を引き出す）を与え、約400頭の馬を健康的に育てています。`}
              </p>
      ...
      <footer className="bg-stone-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 max-w-4xl mx-auto">
            <div>
              ...
              <div className="text-stone-300 text-sm leading-relaxed space-y-1">
                ...
                <p>営業時間: 11時〜16時</p>
                <p>定休日: 12月31日・1月1日</p>
                <p className="text-stone-400 text-xs mt-1">{'（発送もお休みさせて頂きます）'}</p>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto mb-8 rounded-lg overflow-hidden shadow-lg">
            <iframe
              src="https://maps.google.com/maps?q=会津ブランド館+福島県会津若松市七日町6-15&output=embed&hl=ja"
              width="100%"
              height="350"
              style={{ border: 0 }}
              allowFullScreen
